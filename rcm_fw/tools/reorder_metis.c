...
int main(int argc, char **argv)
{
    ...
    int zero = 0;   // C arrays (starting with zero)
    int settings[8] = { 0 };    // default
    metis_nodend(&size, xadj, adjncy, &zero, settings, perm, invp);
    ...
    if (argc > 5) {
        ...
        TWGraph igr = { NULL, adjncy, xadj, NULL, size, 0 };
